...
class mongo_controller(request_handler):
    ...
    def __create(self, p_data):
        try:
            ...
            log.g().e(MANAGE_USER_MESSAGES.S_INSERT_FAILURE + " : " + str(ex))
            return False, str(ex)
    ...
    def __read(self, p_data, p_limit):
        try:
            ...
            log.g().e(MANAGE_USER_MESSAGES.S_READ_FAILURE)
            return str(ex)
    ...
    def __update(self, p_data, p_upsert):
        try:
            ...
            log.g().e(MANAGE_USER_MESSAGES.S_UPDATE_FAILURE)
            return False, str(ex)
    ...
    def __delete(self, p_data):
        try:
            ...
            log.g().e(MANAGE_USER_MESSAGES.S_DELETE_FAILURE)
            return False, str(ex)
