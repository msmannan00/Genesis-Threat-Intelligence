...
/* # for 0.4.3.4-rc Approximate date when this software was released. (Updated
   when the version changes.) */
#define APPROX_RELEASE_DATE "2020-04-09"

/* tor's build directory */
#define BUILDDIR "/cygdrive/c/temp/tor-0.4.6.6"
...
#define PACKAGE_STRING "tor 0.4.3.4-rc"
...
#define PACKAGE_VERSION "0.4.3.4-rc"
...
#define SRCDIR "/cygdrive/c/temp/tor-0.4.6.6"
