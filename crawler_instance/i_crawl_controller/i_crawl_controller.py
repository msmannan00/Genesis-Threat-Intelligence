...
from crawler_instance.i_crawl_controller.parse_manager import parse_manager
from crawler_instance.class_models.index_model import index_model
from crawler_instance.i_crawl_controller.web_request_manager import web_request_manager
